...
// ------------------------- demuxer options --------------------
    ...
    {"prefetch-playlist", OPT_CHOICE(prefetch_open,
        {"no", 0}, {"eof", 1}, {"immediate", 2}, {"yes", 1})},
    {"prefetch-demuxer-max-bytes",
        OPT_BYTE_SIZE(prefetch_demuxer_max_bytes), M_RANGE(0, M_MAX_MEM_BYTES)},
